...
// Zak
// тут был эксплоит. bug fix http://forums.steampowered.com/forums/showthread.php?t=1399232
// надеюсь VALVE починили его
// Just comment out one of the offending commands (i.e. sv_soundemitter_flush in SoundEmitterSystem.cpp) and compile a new server.dll. That should fix it.
