...
public:
	...
	//zak объ€вл€ю новую функцию
	void ACH_SaveToBase (const char steamid[50], const char skill[10], const char mapname[100], int achID, char achName[60], int achPoints, char timeTaken[80], const char nick[100]);
	//zak adren
	short m_iAdrenUsed;
	//
	...
	virtual void OnChangeOnslaught( bool bVar );
