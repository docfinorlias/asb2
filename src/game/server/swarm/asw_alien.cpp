...
//Zak
ConVar asw_alien_speed_scale_easy("asw_alien_speed_scale_easy", "0"); //easy 0.7
ConVar asw_alien_speed_scale_normal("asw_alien_speed_scale_normal", "0"); //normal 1.0
ConVar asw_alien_speed_scale_hard("asw_alien_speed_scale_hard", "0"); //hard 1.7
ConVar asw_alien_speed_scale_insane("asw_alien_speed_scale_insane", "0"); //insane 1.8
