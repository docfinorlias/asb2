...
public:
	...
	//zak : фламер/огнемет
	int m_iFlamerFired;
	bool m_bTeslaGunUsed; //пользовались ли теслой
	...
	//zak - если добавить еще парочку тройку переменных с INT
	...
	short m_iKiller; //количество убийств своих
	short m_iSuicide; //количество самоубийств
	short m_iNoAdrenFastDoorHacks; //количество безадреновых фастхаков полосочек
	short m_iParasitesKilledByChainsaw; //количество убитых паразитов пилой
