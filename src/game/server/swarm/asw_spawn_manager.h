...
private:
	...
	void queueWanderers();
	CountdownTimer spawnRandomAlienTimer;
	int getAlienHull(const char* alien);
	const Vector shiftSpawnPosition(const Vector vecSpawnPos, const Vector vecMins, const Vector vecMaxs, float extraClearanceFactor);
