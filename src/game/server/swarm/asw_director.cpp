...
ConVar asw_horde_interval_min("asw_horde_interval_min", "45", FCVAR_NONE, "Min time between hordes" );
ConVar asw_horde_interval_max("asw_horde_interval_max", "65", FCVAR_NONE, "Min time between hordes" );
ConVar asw_horde_size_min("asw_horde_size_min", "9", FCVAR_NONE, "Min horde size" );
ConVar asw_horde_size_max("asw_horde_size_max", "14", FCVAR_NONE, "Max horde size" );

ConVar asw_director_relaxed_min_time("asw_director_relaxed_min_time", "25", FCVAR_NONE, "Min time that director stops spawning aliens");
ConVar asw_director_relaxed_max_time("asw_director_relaxed_max_time", "40", FCVAR_NONE, "Max time that director stops spawning aliens");
ConVar asw_director_peak_min_time("asw_director_peak_min_time", "1", FCVAR_NONE, "Min time that director keeps spawning aliens when marine intensity has peaked");
ConVar asw_director_peak_max_time("asw_director_peak_max_time", "3", FCVAR_NONE, "Max time that director keeps spawning aliens when marine intensity has peaked");
...
{
	//=====Zak спавним королеву и танка при старте миссии Sewer Junction B5
	const char *mapName = STRING(gpGlobals->mapname);
	if (Q_stricmp(mapName, "asi-jac6-sewerjunction") == 0) // если миссия Sewer Junction B5
	{
		ASWSpawnManager()->SpawnRandomQueen();
