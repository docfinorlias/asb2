...
public:
	...
	//Zak
	bool m_bAllreadyWelcomed; //говорит о том, показывали ли мы приветственное сообщение при входе клиента в игру
	int m_iPointsOnJoined; //очки получаемые из базы при подключении клиента
