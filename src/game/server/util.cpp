...
//zak
/*
Well, I fixed it, but it's a bit strange that the solution requires a change to the way Valve had things set up by default even in the latest Source SDK.
...
Now UTIL_HudHintText will at least be functioning properly.
*/
